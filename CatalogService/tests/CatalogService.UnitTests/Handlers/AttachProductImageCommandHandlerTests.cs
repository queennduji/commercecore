...
{
    [Fact]
    public async Task Handle_ExistingProduct_CreatesImageRecord()
    {
        ...
        var handler = new AttachProductImageCommandHandler(productRepository, productImageRepository, blobStorageService);
