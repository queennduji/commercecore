...
public static class TestTokenFactory
{
    ...
    {
        var key = new SymmetricSecurityKey(Convert.FromBase64String(NotificationApiFixture.JwtKey));
        ...
        var token = new JwtSecurityToken(
            issuer: NotificationApiFixture.JwtIssuer,
            audience: NotificationApiFixture.JwtAudience,
            claims: claims,
