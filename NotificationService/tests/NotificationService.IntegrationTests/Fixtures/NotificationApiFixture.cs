...
public class NotificationApiFixture : IAsyncLifetime
{
    ...
    public FakeEmailGateway EmailGateway { get; } = new();
    public FakeSmsGateway SmsGateway { get; } = new();
    ...
    public async Task InitializeAsync()
    {
        ...
        Factory = new WebApplicationFactory<Program>().WithWebHostBuilder(builder =>
        {
            ...
            builder.ConfigureAppConfiguration((_, configBuilder) =>
            {
                ...
                {
                    ["ConnectionStrings:NotificationDatabase"] = _postgres.GetConnectionString(),
