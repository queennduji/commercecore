...
/// <summary>Mirrors OrderService's OrderDeliveredAvro exactly.</summary>
public class OrderDeliveredAvro : ISpecificRecord
{
    ...
    public void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 2: DeliveredAt = (DateTime)fieldValue; break;
