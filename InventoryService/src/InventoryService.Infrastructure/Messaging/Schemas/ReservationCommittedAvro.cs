...
public class ReservationCommittedAvro : ISpecificRecord
{
    public static readonly Schema _SCHEMA = Schema.Parse(
        """
        {
          "type": "record",
          "name": "ReservationCommittedEvent",
          ...
          "fields": [
            ...
            {"name": "committedAt", "type": {"type": "long", "logicalType": "timestamp-millis"}}
          ]
        }
        """);
    ...
    public void Put(int fieldPos, object fieldValue)
    {
        switch (fieldPos)
        {
            ...
            case 4: CommittedAt = (DateTime)fieldValue; break;
