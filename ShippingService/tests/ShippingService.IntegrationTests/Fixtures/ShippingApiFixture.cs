...
public class ShippingApiFixture : IAsyncLifetime
{
    ...
    public FakeShippingCarrierGateway CarrierGateway { get; } = new();
    ...
    public async Task InitializeAsync()
    {
        ...
        _postgres = new PostgreSqlBuilder("postgres:16")
            ...
            .WithDatabase("shipping_service_test")
        ...
        Factory = new WebApplicationFactory<Program>().WithWebHostBuilder(builder =>
        {
            ...
            builder.ConfigureAppConfiguration((_, configBuilder) =>
            {
                ...
                {
                    ["ConnectionStrings:ShippingDatabase"] = _postgres.GetConnectionString(),
            ...
            {
                services.RemoveAll<IShippingCarrierGateway>();
                services.AddSingleton<IShippingCarrierGateway>(CarrierGateway);
            });
        });
