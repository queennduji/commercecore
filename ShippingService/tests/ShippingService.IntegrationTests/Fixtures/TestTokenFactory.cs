...
public static class TestTokenFactory
{
    ...
    {
        var key = new SymmetricSecurityKey(Convert.FromBase64String(ShippingApiFixture.JwtKey));
        ...
        var token = new JwtSecurityToken(
            issuer: ShippingApiFixture.JwtIssuer,
            audience: ShippingApiFixture.JwtAudience,
            claims: claims,
